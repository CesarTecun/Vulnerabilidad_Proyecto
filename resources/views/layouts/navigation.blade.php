<nav x-data="{ open: false }" class="bg-white dark:bg-gray-800 border-b border-gray-100 dark:border-gray-700">
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex justify-between h-16">
            ...
            <div class="flex items-center">
                {{-- Notificaciones --}}
                <div class="flex items-center justify-center me-6">
                    <button @click="window.location.href='{{ route('notificaciones.index') }}'" 
                        ...
                        @if(($notificaciones = Auth::user()?->unreadNotifications()->count() ?? 0) > 0)
    ...
    <div :class="{ 'block': open, 'hidden': ! open }" class="hidden sm:hidden">
        <div class="pt-2 pb-3 space-y-1">
            ...
            <x-responsive-nav-link :href="route('vulnerabilidades.index')" :active="request()->routeIs('vulnerabilidades.index')">
                {{ __('Vulnerabilidades') }}
            </x-responsive-nav-link>

            <x-responsive-nav-link :href="route('vulnerabilidades.create')" :active="request()->routeIs('vulnerabilidades.create')">
